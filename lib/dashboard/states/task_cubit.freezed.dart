...
class _$TaskStateImpl implements _TaskState {
  const _$TaskStateImpl({this.isLoading = false, this.error, this.data});
  ...
  @override
  String toString() {
    return 'TaskState(isLoading: $isLoading, error: $error, data: $data)';
  }
...
abstract class _TaskState implements TaskState {
  const factory _TaskState(
      {final dynamic isLoading,
      final Failure? error,
      final dynamic data}) = _$TaskStateImpl;
